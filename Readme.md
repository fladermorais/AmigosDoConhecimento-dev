...
Conforme informado pretendemos seguir o seguinte fluxo:
* Marcação HTML (Branch html_simples)
* Estilizar com CSS e Bootstrap (Branch html)
* Transformando o HTML em PHP para reaproveitar trechos do código (Branch php)
* Criar um pequeno sistema de Rotas com base no GET da URL (Branch php_intermediario)
* Conectar a um banco de dados já existente para exibir as informações na tela inicial
* Implementar o Laravel (utilizando o blade)